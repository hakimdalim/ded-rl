#!/bin/bash
#SBATCH --job-name=ded_random_single_track
#SBATCH --nodes=1
#SBATCH --ntasks=16
...
# Production submission script for random material single-track experiments
# Full factorial design: 11×5×5×10 = 2,750 parameter combinations
# With 3 material variants each = 8,250 total experiments
# Split across 30 job arrays, each handling 275 experiments
# 16 parallel experiments × 1 CPU each
# Uses SLURM steps instead of GNU Parallel

echo "=========================================="
echo "DED Random Material Single-Track Production Run"
echo "=========================================="
...
TOTAL_EXPERIMENTS=8250  # 2750 parameter combinations × 3 material variants

# Shared directories
POWDER_STREAM_DIR="/scratch/schuermm-shared/sim_powder_stream_arrays"
MATERIALS_DIR="/scratch/schuermm-shared/random_materials"  # Directory with generated material JSON files
OUTPUT_BASE_DIR="/scratch/schuermm-shared/ded_random_single_track"
...
# Parameter ranges (same as material generation)
