#!/bin/bash
#SBATCH --job-name=ded_17-4PH_single_track
#SBATCH --nodes=1
#SBATCH --ntasks=16
...
# Production submission script for 17-4PH single-track experiments
...
echo "=========================================="
echo "DED 17-4PH Single-Track Production Run"
echo "=========================================="
...
OUTPUT_BASE_DIR="/scratch/schuermm-shared/ded_17_4PH_single_track"
