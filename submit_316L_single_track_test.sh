...
# Single array job (array=0) for quick testing
# Runtime: 2 hours (conservative for 32 experiments with 12 parallel jobs)
...
OUTPUT_BASE_DIR="/scratch/schuermm-shared/ded_316L_experiments_TEST"  # Separate test directory
